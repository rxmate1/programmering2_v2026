...
public class Carpenter extends Person {
    ...
    /*
    Dette er en private instansvariabel som er unik for Carpenter og representerer hvor mange hus en "snekker" har bygd.
     */
    ...
    Dette innebærer at konstruktøren må typisk ha minst samme parametere som foreldreklassen sin, men kan ha flere egne
    i tillegg. Under ser vi at de tre første parameterene er de samme som Person-konstruktøren tar, mens den fjerde er
